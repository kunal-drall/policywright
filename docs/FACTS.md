...
not conflate the two. **Update 2026-09-02 (§18.1):** the RFP's public traces —
the SCF #44 round page listing three funded "policy builder" responses, the
Gateway.fm project page's "the RFP's record-and-generate toolkit", the Medium
round recap — and the handbook's quarterly RFP cycle (SCF #44 deadline June 14, 2026) corroborate the RFP's name and quarter; the site states provenance with
the owner's canonical sentence verbatim. The public page does not expose per-deliverable
...
| Docs site deployment           | Vercel project `policywright-docs` (team `team_MiLz…`, domain `policywright.lemmalabs.space`): the latest production deployment is from **2026-08-06** (commit `9b8fc75`, created through the CLI); the project has **no git integration**, so pushes do not publish, and the CLI on this machine has no credentials (`vercel whoami` → "No existing credentials found"). Every site page committed since — the D2.1–D2.5 changes and the close-out pages — builds green in CI but is **not live**; the live `/roadmap/` lacks the T2 rows and `/reference/skill/` etc. return 404 | Vercel API through the claude.ai connector (`get_project`, `list_deployments`); `vercel whoami`; `curl` of the live pages |
...
## GATE 18 — Prompt D: the docs site brought to current, provable reality (verified 2026-09-02)

### 18.1 Public-status truth and the RFP (gate G2)

| Fact                                                  | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Verified by                                                                                                                                                                                                                                                                                       |
| ----------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Project page                                          | `https://communityfund.stellar.org/project/policywright-j8x` — HTTP 200, public, no login wall; "Policywright", SCF #44, "Record-to-Policy MCP + Agent skill", Awarded, $55.0K, team of 2 (unchanged from §6)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | fetch + `curl -o /dev/null -w '%{http_code}'`                                                                                                                                                                                                                                                     |
| Where SCF RFPs live                                   | The SCF Handbook's RFP Track page publishes RFPs "at the start of each quarter" and rotates them: on 2026-09-02 it lists the Q3 / SCF #45 RFPs (a Stellar-compatible LayerZero DVN; an x402 facilitator) and says "July 23, 2026: New Q3 RFPs are open for submissions for SCF #45!". The Q2 2026 (SCF #44) RFP text is therefore not at a stable public URL today                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `https://stellar.gitbook.io/scf-handbook/scf-awards/build-award/rfp-track`                                                                                                                                                                                                                        |
| Public traces of the "OZ accounts policy builder" RFP | (a) the SCF #44 round page lists the funded responses: "OZ Policy Builder by Crediolabs.ai" ($125.0K), "OpenZeppelin Accounts Policy Builder" by Gateway.fm ($98.0K) and "Record-to-Policy MCP + Agent skill" by Policywright ($55.0K); the awards index shows SCF #44 as an ended round with a June 14, 2026 submission deadline (Q2 2026). (b) Gateway.fm's project page says "We will build the RFP's record-and-generate toolkit: a developer or agent points at a transaction they have already performed, and the tool auto-generates a tightly scoped, minimum-permission policy…". (c) The "SCF #44 Round Recap" on Medium (Stellar Community, Jul 2026), as indexed by web search, describes the RFP: "The OZ accounts policy builder is an AI-assisted toolkit — MCP server plus agent skill…" and names the three awardees including Policywright — but `medium.com` returns HTTP 403 to non-browser clients (verified with `curl`, browser UA), so it is recorded here and **not linked from the site** | `https://communityfund.stellar.org/awards/rec4FnYypcsKpBRB4` (200); `https://communityfund.stellar.org/awards` (200); `https://communityfund.stellar.org/project/oz-accounts-policy-builder-by-gatewayfm-mqp` (200); web search of `medium.com/stellar-community/scf-44-round-recap-b5e8acd87045` |
| Consequence for the site                              | The site states provenance with the project owner's canonical sentence, verbatim: "Built in response to the SCF 'OZ accounts policy builder' RFP (Q2 2026), funded in round SCF #44 as the awarded submission 'Record-to-Policy MCP + Agent skill.'" — "SCF #44" links the round page, the submission title links the project page. The RFP's name and quarter are corroborated by (a)–(c); the fact that policywright responded to it is the owner's statement (the portal does not say which submissions answered which RFP). §6's note stands: Gateway.fm's and Crediolabs' projects are other responses to the same RFP, not policywright                                                                                                                                                                                                                                                                                                                                                                       | this session                                                                                                                                                                                                                                                                                      |

### 18.2 The live site before this work

| Fact             | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Verified by                                                                                             |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| Deployed content | still the 2026-08-06 production deployment `dpl_9sNucBME3NLQdwzH8LtXyp4JTDU4` of commit `9b8fc75` (created through the CLI; `gitDirty: 1`); Overview badge "Status: In development", sidebar Overview · Architecture · Getting Started · Context rules · Policies · Least-privilege model · Design principle: compose-first · Security · Roadmap · CLI · MCP tools · Changelog; no Tranche 2 text; `/roadmap/` and `/reference/mcp-tools/` 200 (old content), `/reference/skill/` **404** | Vercel API through the claude.ai connector (`get_project`, `list_deployments`); fetch of the live pages |
| Publishing path  | the Vercel project `policywright-docs` (team `team_MiLz…`) has no git integration — a push does not publish; the Vercel CLI on this machine has no credentials (`vercel whoami` → "No existing credentials found")                                                                                                                                                                                                                                                                        | `vercel whoami`; connector                                                                              |

### 18.3 Build and render facts (gate G4)

| Fact                       | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Verified by                                                                                                              |
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| Toolchain (installed)      | Astro 7.1.3, Starlight 0.41.3, Mermaid 11.16.0 (`site/node_modules/*/package.json`); Node 22.20.0                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `grep version`                                                                                                           |
| `cd site && npm run build` | exit 0 — **19 content pages** (15 before + the 4 use cases) plus Astro's generated `404.html`, which is what the build's "20 page(s) built" line counts; Pagefind "Found 40 HTML files", `sitemap-index.xml`; the only warning is Vite's chunk-size note for the Mermaid bundle                                                                                                                                                                                                                                                                                      | local build (×5 in the session; the first failure was four pages written to a nested path by a drifted shell cwd, fixed) |
| Smartypants                | Astro's default `smartypants` converted `'` to `’` in the rendered HTML (observed on the skill page), which would break a literal grep for the provenance sentence and for quoted outputs; `markdown: { smartypants: false }` added to `astro.config.mjs`. After it, the provenance sentence and the banner grep-match verbatim in the built HTML (tags stripped)                                                                                                                                                                                                    | Python over `dist/**/index.html`                                                                                         |
| Mermaid renders            | Headless Google Chrome (puppeteer-core 24.43.1) against `astro preview`: `/architecture/` → SVG with 23 nodes / 25 edges; `/reference/smart-account-install/` → 6 nodes / 5 edges; the `<pre>` fallback replaced; in both `prefers-color-scheme` light (`data-theme="light"`, body `rgb(255, 255, 255)`) and dark (`data-theme="dark"`, body `rgb(31, 41, 55)`); zero console or page errors across 5 pages × 2 themes; no horizontal scroll at 390 px. `flowchart LR` rendered the 23-node diagram at 632 px width (illegible), so both diagrams use `flowchart TB` | `scratchpad/render/check.mjs`, screenshots                                                                               |
| Search                     | Pagefind UI returns results for "Delegated", "TX_NOT_FOUND", "Audit Bank", "SEP-41" (headless run)                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `scratchpad/render/search.mjs`                                                                                           |
| Status badges and banner   | `StatusBadge` gained an optional `note` ("Shipped (testnet)", "Planned (walkthrough — Tranche 3, target 30 Nov 2026)"); every one of the 19 content pages renders a badge and the banner sentence verbatim (checked in the built HTML; Astro's generated `404.html` carries neither, by construction); no page says "In development"                                                                                                                                                                                                                                 | Python over `dist/**/index.html`                                                                                         |

### 18.4 Every link and every command on the site (gate G3)

| Check                      | Result                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Links in the built HTML    | 196 unique external URLs → 174 distinct after stripping anchors, **all HTTP 200** (`curl -L`, browser UA); every `github.com/kunal-drall/policywright/blob                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | tree/main/<path>`maps to a path in the working tree; every`#anchor`into`evidence/EVIDENCE.md`and`docs/\*.md`matches a heading under GitHub's slug rule (lowercase; drop punctuation other than`-`, `\_`, space; space → `-`; consecutive hyphens kept); every internal `/slug/`and`#anchor`resolves in`dist/` |
| Commands run for the pages | `npm ci`-equivalent tree; `npm run demo` (exit 0); `npm test` (215 passed); `npm run build`; `npm run cli -- help`; `synth` (fixture, `--input …recorded-claim-swap.json`, `--input …fresh.json`, `--lifetime 604800 --cap-multiplier 1.25` → cap 1543.125 BLND, 120960 ledgers); `simulate` (fixture; `--input …fresh.json` both modes — byte-identical to the committed reports); `synth --out … $(cat synth.args)` for `fresh/` and `demo/` (`diff -r` clean); `npm run mcp:schemas -- --check` (9 files match); `skills-ref@0.1.5 validate` (Valid skill) and `read-properties`; `record --from-simulation examples/live/simulated-soroswap-swap.json --account GABJUTWU…` (exit 0); `record` by the T1 hashes (`TX_NOT_FOUND`, node window ledgers 4348101–4469060, oldest closed 2026-08-26T17:05:17.000Z); `claude mcp list` (`✓ Connected`); `verify` ×2 (below); `install --dry-run` (below) |
| Live testnet re-checks     | `verify` D2.5 artifact + D2.5 log → **PASS 15/15** at ledger **4469061**, rules found as ids 1–3, ids 4–6 listed as informational extras; `verify` demo artifact + demo log → **PASS 15/15** at 4469062, ids 4–6; `scripts/install-testnet.sh examples/live/fresh/context-rule.json --dry-run` → three enforcing simulations passed, 2 auth entries each, head 4469062 → `valid_until` 4987462, min resource fees 118420 / 118421 / **126851** (the BLND rule's fee was 180149 in the 2026-09-02 10:57 dry run — resource fees vary per simulation), `local-fallback`, nothing submitted. The dry-run log it wrote was deleted; **nothing was installed in this session**                                                                                                                                                                                                                             |
| Drift caught               | `getting-started.mdx` quoted a `npm run demo` output "re-run 2026-09-02" whose argument-scope line read `argument-constraint: …`; today's output reads `argument-constraint (swap-path): …` (D2.3 changed the label). The page now embeds today's output verbatim, injected from the captured log                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |

### 18.5 Repository and CI state (unchanged)

Fork; every green CI run is a manual `workflow_dispatch`; GitHub Issues
disabled (`hasIssuesEnabled: false`). The CI run for this work is cited in
[EVIDENCE.md](../evidence/EVIDENCE.md) § D7 once dispatched.
...
| 2026-09-02 | Prompt D session: added §18 — the docs site brought to current reality: public-status truth and the RFP's public traces (handbook RFP page rotates quarterly; SCF #44 round page, Gateway.fm page, Medium recap 403 to bots), the live site's 2026-08-06 state (skill page 404, no Vercel git integration, no CLI credentials), build/render facts (19 content pages + a generated 404, Pagefind, Mermaid SVG in both themes via headless Chrome, `smartypants: false`, `StatusBadge` note), the link check (174 URLs all 200; GitHub paths and anchors resolve), every command re-run for the pages, live testnet re-checks (verify PASS at 4469061/4469062; dry run head 4469062; nothing installed), and the drifted demo-output line caught. §6 amended with the RFP note.                                                                                                                                                                                                                       |
